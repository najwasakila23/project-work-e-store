        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body d-flex justify-content-between">
                    <h4 class="text-start">Edit Toko</h4>
            ...
            <div class="card">
                <form method="POST" action="{{ route('toko.update', $data->id) }}" role="form" enctype="multipart/form-data">
                    {{ method_field('PATCH') }}
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-md-6 col-6">
                            <div class="mb-1">
                                ...
                                <input type="text" class="form-control" placeholder="Nama Toko" name="name" value="{{ $data->name }}">
                            </div>
                            <div class="mb-1">
                            ...
                            <div class="mb-1">
                                ...
                                <input type="bigInteger" class="form-control" placeholder="08387773707" name="noTelp" value="{{ $data->noTelp }}">
                            </div>
                        </div>
                        <div class="col-md-6 col-6">
                            <div class="mb-1">
                            ...
                            <div class="mb-1">
                                ...
                                <input type="text" class="form-control" placeholder="rt02/03 15B" name="address" value="{{ $data->address }}">
                            </div>
                        </div>
                    </div>
                </div>
