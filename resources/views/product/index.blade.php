        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body d-flex justify-content-between">
                    ...
                    <a href="{{ route('product.create') }}" class="btn btn-primary btn-sm float-right font-weight-bolder mr-1"><i class="ni ni-fat-add"></i>Tambah Data</a>
                </div>
            </div>
        </div>    
            </div><br>
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                            <li><a class="dropdown-item font-small-1"
                                                href="{{ route('product.index', $data->nama) }}"><i data-feathers='eye'
                                                    class="font-small-1 mr-1"></i>Show</a>
                                            </li>
                                            <li><a class="dropdown-item font-small-1"
                                                href="{{ route('product.edit', $data->id) }}"><i data-feathers='eye'
